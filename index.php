...
<body class="bg-gradient-login" style="background-image: url('img/logo/slide3.jpg');  background-position: center;
  background-size: cover;">
  <!-- Login Content -->
              ...
              <div class="col-lg-12">
                ...
                <h5 align="center">STUDENT ATTENDANCE SYSTEM</h5>
                  <div class="text-center">
                    <img src="img/logo/header.png" style="width:100%;height:100px">
                    <br><br>
